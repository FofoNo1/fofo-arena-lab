...
5. Plan analysis, viewer and coaching modules based on actual findings.
...
- Do not create large architecture documents unless asked.
- Do not add dependencies without explaining why.
- Do not commit private replay files, secrets, tokens or company data.
